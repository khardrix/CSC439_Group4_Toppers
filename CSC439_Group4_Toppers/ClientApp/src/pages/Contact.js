...
export class Contact extends Component {
    /*
    onSubmit = fields => {  // Changed from "onSubmit" to "onSubmit2"
        console.log('App comp got: ', fields);
        alert('App comp got: ', fields);
    }
    */
    constructor(props) {
        super(props);
    ...
    onSubmit = (e) => {
        e.preventDefault();
        alert(this.state);
        /*console.log(this.state);*/ // This is the code from the tutorial
        this.props.onSubmit(this.state); // Changed from "onSubmit" to "onSubmit2"
        this.setState({
            contactReason: "",
            fullName: "",
            email: "",
...
/*
<button id="btn_contactUsFormSubmit" onClick={e => this.onSubmit(e)}>Submit</button> // Changed from "onSubmit" to "onSubmit2"
*/
